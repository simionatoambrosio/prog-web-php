  ...
  <body>
    <main class="container mt-5">
        ...
        <div class="d-flex justify-content-between">
            <h3>Produto</h3>
            <a href="/produto/inserir" class="btn btn-primary"> <i class="fas fa-plus"></i> Novo produto</a>
        </div>
            ...
            <tbody>
                <?php while($c = $resultado->fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr>
                        ...
                        <td><?= $c['categoria'] ?></td>
                        <td>
                            <a href="/produto/alterar/id/<?= $c["id"] ?>" class="btn btn-sm btn-warning">Alterar</a>
                            <a href="/produto/excluir/id/<?= $c["id"] ?>" class="btn btn-sm btn-danger">Excluir</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
